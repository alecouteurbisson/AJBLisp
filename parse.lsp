  ...
  (loop
    ...
    (cond
      ...
      (t
        (print " + ")
        (print-expr (car e) 10) )))
  (when (> prec 10) (print rpar)) )

(defun print-product (e (prec . 0))
  (when (> prec 20) (print lpar))
  (print-expr (car e) 20)
  (loop
    (pop e)
    (while e)
    (cond
      ...
      (t
        (print " * ")
        (print-expr (car e) 20) )))
   (when (> prec 20) (print rpar)) )

 (defun print-inverse(e (prec . 0))
   (when (> prec 30) (print lpar))
   (print "/")
   (print-expr (car e) 30)
   (when (> prec 30) (print rpar)) )

 (defun print-neg(e (prec . 0))
   (when (> prec 40) (print lpar))
   (print "-")
   (print-expr (car e) 40)
   (when (> prec 40) (print rpar)) )

 (defun print-power(e (prec . 0))
   (when (> prec 50) (print lpar))
   (print-expr (car e) 50)
   (print " ^ ")
   (print-expr (cadr e) 50)
   (when (> prec 50) (print rpar)) )

 (defun print-fact(e (prec . 0))
   (when (> prec 60) (print lpar))
   (print-expr (car e) 60)
   (print "!")
   (when (> prec 60) (print rpar)) )
...
(defun parser ()
  (let ((expr)(val))
    (loop
      ...
      (println "result:     " (setq val (parse expr)))
...
(defun test () (test-parse expressions))
