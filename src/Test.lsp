...
(defun property ()
  (let ((sym) (props))
    (put 'sym 'colour 'green)
    (put 'sym 'size 3)
    (put 'sym 'name "fred")
    (test (get 'sym 'size)         3)
    (test (get 'sym 'name)         "fred")
    (test (get 'sym 'colour)       green)
    (put 'sym 'size 10)
    (test (get 'sym 'size)         10)
    (test (get 'sym 'age)          :undefined)
    (remprop 'sym 'colour)
    (test (get 'sym 'colour)       :undefined)
    (setq props (plist 'sym))
    (test (equal (remprop 'sym)
                 props)            t)
    (test (get 'sym 'size)         :undefined)
    (test (get 'sym 'name)         :undefined)
    (test (plist 'sym)             nil) ))
...
(defun basic-list ()
  ...
  (test (cadr '((a b) c))        c)
  (test (cddr '((a b) c d))      (d))
  (test (caaar '(((a b) c) d))   a)
  (test (cdaar '(((a b) c) d))   (b))
  (test (cadar '((a (b c)) d))   (b c))
  (test (cddar '((a b c) d))     (c))
  (test (caddr '(a b (c d)))     (c d))
...
(defun vector-ops ()
  ...
  (slet ((v (vector '(a b c d e)))
    ...
    (test (length v)                    5)
    (test (reverse v)                   #(e d c b a))
    (test (reverse v 3)                 #(c b a))
    (vset v2 2 'x)
    (test v2                            #(a b x d e))
    (test v                             #(a b c d e)) ))
...
(defun equality ()
  ...
  (test (equal #(a b c) #(a b c))       t)
  (test (equal '(a b c) #(a b c))       nil))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; Stack
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(defun stack ()
  (heading "Hammer the stack")
  (test (tak 18 12 6) 7) )
...
(defun logical ()
  ...
  (test (band 0x00ff 0x0f0f 0xCCCC) 0x000C)
  (test (bor  0x00ff 0x0f0f)        0x0fff)
  (test (bor  0x00ff 0x0f0f 0xCCCC) 0xCfff)
  (test (bxor 0x00ff 0x0f0f)        0x0ff0)
  (test (bxor 0x00ff 0x0f0f 0xCCCC) 0xC33C)
  (test (bset 0 0x0)                0x1)
...
(defun num-order ()
  ...
  ; Fuzzy equality
  (test (= 1.0 1.002 0.003) t)
  (test (= 1.0 1.002 0.001) nil) )
...
(defun type-ops ()
  ...
  (slet
    ((vect #(2 2))
     ...
     (types (list  nil 'a '(a) 0 1 0.0 1.0 5 5.0 -1 -1.0 #\x "Hi" vect list let :stdin :create ':err_num_args)) )

    (test (test-types atom)       (t   t   nil t   t   t   t   t   t   t   t   t   t   nil t   t   t   t   t  ))
    (test (test-types zerop)      (nil nil nil t   nil t   nil nil nil nil nil nil nil nil nil nil nil nil nil))
    (test (test-types onep)       (nil nil nil nil t   nil t   nil nil nil nil nil nil nil nil nil nil nil nil))
    (test (test-types minusp)     (nil nil nil nil nil nil nil nil nil t   t   nil nil nil nil nil nil nil nil))
    (test (test-types plusp)      (nil nil nil t   t   t   t   t   t   nil nil nil nil nil nil nil nil nil nil))
    (test (test-types consp)      (nil nil t   nil nil nil nil nil nil nil nil nil nil nil nil nil nil nil nil))
    (test (test-types symbolp)    (nil t   nil nil nil nil nil nil nil nil nil nil nil nil nil nil nil t   t  ))
    (test (test-types numberp)    (nil nil nil t   t   t   t   t   t   t   t   nil nil nil nil nil nil nil nil))
    (test (test-types integerp)   (nil nil nil t   t   nil nil t   nil t   nil nil nil nil nil nil nil nil nil))
    (test (test-types floatp)     (nil nil nil nil nil t   t   nil t   nil t   nil nil nil nil nil nil nil nil))
    (test (test-types charp)      (nil nil nil nil nil nil nil nil nil nil nil t   nil nil nil nil nil nil nil))
    (test (test-types stringp)    (nil nil nil nil nil nil nil nil nil nil nil nil t   nil nil nil nil nil nil))
    (test (test-types listp)      (t   nil t   nil nil nil nil nil nil nil nil nil nil nil nil nil nil nil nil))
    (test (test-types vectorp)    (nil nil nil nil nil nil nil nil nil nil nil nil nil t   nil nil nil nil nil))
    (test (test-types subrp)      (nil nil nil nil nil nil nil nil nil nil nil nil nil nil t   nil nil nil nil))
    (test (test-types fsubrp)     (nil nil nil nil nil nil nil nil nil nil nil nil nil nil nil t   nil nil nil))
    (test (test-types filep)      (nil nil nil nil nil nil nil nil nil nil nil nil nil nil nil nil t   nil nil))
    (test (test-types keyp)       (nil nil nil nil nil nil nil nil nil nil nil nil nil nil nil nil nil t   nil))
    (test (test-types constantp)  (nil nil nil nil nil nil nil nil nil nil nil nil nil nil nil nil nil t   t  ))

    (test (mapc typeof types)       (nil :symbol :cons :integer :integer :float :float :integer :float
                                     :integer :float :character :string :vector :subrl :fsubrl :file :key :constant) )))
...
(defmacro test(expr expected)
  (let
    ...
    (cond
      ((equal result :err_user) (error :err_user))
      ((atom result)
      ...
      ((equal (car result) expected)
       (when verbose (println expr " = " expected)) )
...
(defmacro expect-error(expr err)
  ...
  (let ((result (errorset (eval expr))))
    (cond
      ((eql result :err_user) (error :err_user))
      ((eql result err)
       (when verbose (println "Exception " err " properly caught in " expr)) )
      ((numberp result)
       (when verbose (println "Wrong exception [" result "] caught in "
                               expr ", should be [" err "]" ))
       (setq failed
